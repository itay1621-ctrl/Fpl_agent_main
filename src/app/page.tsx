        ...
        <div className="max-w-6xl mx-auto p-4 sm:p-6 pb-20">
          ...
          {activeTab === 'pitch' && (
            <div className="max-w-4xl mx-auto">
              <div className="bg-[#126b3f] rounded-t-lg p-4 relative shadow-md overflow-hidden min-h-[500px] flex flex-col justify-around">
              ...
              <div className="bg-[#0e5230] rounded-b-lg p-4 flex justify-center gap-2 sm:gap-6 shadow-md z-20 relative border-t-2 border-white/20 border-dashed">
          ...
          {activeTab === 'transfer' && (
            <div className={`mt-4 p-6 rounded-2xl shadow-sm border ${bgCard}`}>
          ...
          {activeTab === 'planner' && (
            <div className={`mt-4 p-6 rounded-2xl shadow-sm border ${bgCard} relative`}>
              <h3 className={`text-2xl font-black mb-6 flex items-center gap-2 ${textHighlight}`}>
...
function PlayerCard({ 
  ...
  return (
    <div className={`relative flex flex-col items-center w-[60px] min-[400px]:w-[70px] sm:w-[95px] transition-all duration-300 ${isBench && !isActionMode ? 'opacity-90 hover:opacity-100' : ''} ${isSelected ? 'scale-110 z-30' : ''}`}>
      ...
      {/* Fixture */}
      <div className={`w-full text-center text-[9px] sm:text-[10px] font-bold py-0.5 shadow-sm ${getDiffColor(player.fixture_diff)}`}>
  ...
  const renderPlayer = (p: any, isBench: boolean = false) => {
    ...
    return (
      <div key={p.id} className={`flex flex-col items-center w-20 sm:w-24 transition-transform hover:scale-105 ${isBench ? 'opacity-90 hover:opacity-100' : ''}`}>
        ...
        <div className={`mt-1 text-[9px] sm:text-[10px] font-bold w-full text-center drop-shadow-sm ${isBench ? (isDarkMode ? 'text-gray-300' : 'text-gray-700') : 'text-white'}`}>
        ...
        <div className="flex flex-wrap justify-center gap-1 mt-1 w-[110%]">
          ...
          {!isBench && (
            <>
              ...
              >
                <span className="text-[10px] sm:text-xs font-black">C</span>
              </button>
              <button 
                onClick={() => onVice(p.id)}
                disabled={swapSourceId !== null}
              ...
              >
                <span className="text-[10px] sm:text-xs font-black">V</span>
              </button>
            </>
          )}
        </div>
    ...
    <div className="flex flex-col w-full">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className={`w-full lg:w-3/4 max-w-5xl mx-auto rounded-3xl shadow-xl overflow-hidden border-4 flex flex-col ${isDarkMode ? 'border-gray-800' : 'border-gray-300'}`}>
          <div className="bg-[#126b3f] p-4 sm:p-6 md:p-8 relative flex flex-col justify-around min-h-[600px] flex-grow">
            <div className="absolute inset-0 opacity-20 pointer-events-none overflow-hidden">
              <div className="absolute top-1/2 left-0 right-0 h-1 bg-white"></div>
          ...
          <div className={`p-4 sm:p-6 md:p-8 flex justify-center gap-2 sm:gap-6 md:gap-8 border-t-2 border-white/20 border-dashed z-20 bg-[#0e5230]`}>
